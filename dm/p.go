...
const (
	...
	compressDef   = Dm_build_743
	compressIDDef = Dm_build_744
...
func (c *DmConnector) setAttributes(props *Properties) error {
	...
	c.bufPrefetch = props.GetInt(BufPrefetchKey, c.bufPrefetch, int(Dm_build_728), int(Dm_build_729))
...
func (c *DmConnector) connectSingle(ctx context.Context) (*DmConnection, error) {
	...
	dc.Access, err = dm_build_421(dc)
	if err != nil {
		return nil, err
	}

	if err = dc.Access.dm_build_462(); err != nil {
